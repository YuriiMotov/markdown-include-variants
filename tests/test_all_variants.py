...
def test_all_variants_plain():
    input_md = inspect.cleandoc(
        """
        {* docs_src/all_variants/tutorial001_an_py311.py *}
        """
    )
    ...
    assert result == snapshot(
        inspect.cleandoc(
            ...
            <p>//// tab | Python 3.11+
            <code>python
            {!docs_src/all_variants/tutorial001_an_py311.py!}</code></p>
            <p>////</p>
...
def test_all_variants_ln_hl():
    input_md = inspect.cleandoc(
        """
        {* docs_src/all_variants/tutorial001_an_py311.py ln[3:5] hl[4:5] *}
        """
    )
    ...
    assert result == snapshot(
        inspect.cleandoc(
            ...
            <p>{!docs_src/all_variants/tutorial001_an_py311.py[ln:3-5]!}</p>
...
def test_all_variants_ln_hl_title():
    input_md = inspect.cleandoc(
        """
        {* docs_src/all_variants/tutorial001_an_py311.py ln[3:5] hl[4:5] title["main.py"] *}
        """
    )
    ...
    assert result == snapshot(
        inspect.cleandoc(
            """
            <p>//// tab | Python 3.11+
            ```python hl_lines="4-5" title="main.py"</p>
            <h1>Code above omitted 👆</h1>
            <p>{!docs_src/all_variants/tutorial001_an_py311.py[ln:3-5]!}</p>
            <h1>Code below omitted 👇</h1>
            <p>```</p>
            ...
            <p>///// details | 👀 Full file preview</p>
            <p>//// tab | Python 3.11+</p>
            <p><code>python hl_lines="4-5" title="main.py"
            {!docs_src/all_variants/tutorial001_an_py311.py!}</code></p>
            <p>////</p>
            <p>/////</p>
            <p>///// details | 🤓 Other versions and variants</p>
            <p>//// tab | Python 3.10+</p>
            <p><code>python title="main.py"
            {!docs_src/all_variants/tutorial001_an_py310.py!}</code>
            ////
            //// tab | Python 3.9+</p>
            <p><code>python title="main.py"
...
def test_all_variants_ln_hl_title_include():
    input_md = inspect.cleandoc(
        """
        {* docs_src/all_variants/tutorial001_an_py311.py ln[3:5] hl[4:5] title["main.py"] *}
        """
